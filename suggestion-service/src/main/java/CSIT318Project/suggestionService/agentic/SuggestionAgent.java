...
public interface SuggestionAgent {
    ...
    4. **Validate:** You must not invent, fabricate, or modify any educational resources. Only return resources that exactly match entries from the availableResources list. Do not create new resourceId values or generate new titles, descriptions, or URLs.
    ...
    2. **Match:** Identify which educational resources from the availableResources list best align with the user's demonstrated interests, preferred genres, and knowledge level based on their order history.
